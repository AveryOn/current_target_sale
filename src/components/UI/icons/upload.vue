<template>
    <!-- <svg class="icon settings" xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 25 25">
    ...
    <svg class="upload" viewBox="-1 -1 25 25" xmlns="http://www.w3.org/2000/svg">
